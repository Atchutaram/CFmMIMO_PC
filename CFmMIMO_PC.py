...
parser.add_argument('-mo', '--model', choices={"0", "1"}, help='TBD', default="0", metavar='TBD', )

args = parser.parse_args()
number_of_samples, operating_mode, scenario, host, retain, _ = map(int, (args.samples, args.mode, args.scenario, args.host, args.retain, args.model, ))
